...
namespace DataModel.CoinmaketEntity
{
    /// <summary>
    /// Ticker information.
    /// </summary>
    ...
    public class CyproEntity
    {
        ...
        public string first_historical_data { get; set; }

        public string last_historical_data { get; set; }



    }

    public class CyproPriceEntity
    {
        public long id { get; set; }
        public string name { get; set; }
        public string symbol { get; set; }
        ...
        public IDictionary<string, PriceEntity> quote { get; set; }
    ...
    public class CoinMarketDataRespon
    {
        public List<CyproEntity> data { get; set; }
        public ResponStatus status { get; set; }

    }


    public class CoinMarketDataResponT2
    {
        public List<CyproPriceEntity> data { get; set; }
        public ResponStatus status { get; set; }
